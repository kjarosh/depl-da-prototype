        ...
        fun createFromConfig(config: Config): LoadGenerator =
            when (config.loadGeneratorConfig.loadGeneratorType.lowercase()) {
                ...
                "increasing" ->
                    ...
                    "Load Generator cannot be created from type: ${config.loadGeneratorConfig.loadGeneratorType}. Possible values are: constant, bound or increasing",
                )
            }
    }
}
